...
const Route2 = createFileRoute("/")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Rastreador de dívidas offline. Adicione quem te deve, marque como pago e gerencie dívidas recorrentes — tudo salvo no seu dispositivo."
    }, {
      name: "theme-color",
      content: "#10b981"
    }, {
      property: "og:title",
      content: "Devendo — Controle de dívidas a receber"
    }, {
